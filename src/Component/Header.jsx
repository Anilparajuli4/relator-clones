...
function Header() {
  ...
  return (
    <div className="border shadow-sm sticky top-0 z-[50] bg-white">
          ...
          <ul className="flex space-x-10 text-gray-400 cursor-pointer">
            <li
              className={`py-3 font-semibold text-sm border-b-[3px] border-b-transparent ${
                pathMatchRoute("/") && "border-b-red-600 text-black"
              }`}
              onClick={() => navigate("/")}
            >
              Home
            ...
            <li
              className={`py-3 font-semibold border-b-[3px] border-b-transparent text-sm ${
                pathMatchRoute("/offers") && "border-b-red-600 text-black"
              }`}
            ...
            <li
              className={`py-3 font-semibold border-b-[3px] border-b-transparent text-sm ${
                pathMatchRoute("/sign-in") && "border-b-red-600 text-black"
              }`}
